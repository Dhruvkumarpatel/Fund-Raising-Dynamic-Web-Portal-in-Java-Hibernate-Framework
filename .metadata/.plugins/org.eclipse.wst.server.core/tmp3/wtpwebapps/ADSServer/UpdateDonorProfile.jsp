...
<div id="tooplate_wrapper">
   ...
   <h5>  welcome to Fund Raising  </h5>
           ...
           <a href=""><h3>List Of Organizations</h3></a>
           </td>
           </tr>
    ...
    <input type="hidden" name="oldUserId" id="userId" value="<%=request.getParameter("userid") %>" />
        <table cellpadding="3pt">
        
            <tr>
                <td>User ID <span class="acsentric">*</span> :</td>
                <td><input type="text" name="userId" size="30" value="<%=request.getParameter("userid") %>>" required /></td>
            </tr>
            <tr>
             ...
             <tr>
                ...
                <td><input type="password"  id="repassword" name="Repassword" size="30" required /> <span id="error">password does not match</span></td>
            </tr>
 
          
            <tr>
                <td>Email <span class="acsentric">*</span> :</td>
                <td><input type="email" name="email" size="30" value="<%=request.getAttribute("email") %>" required/></td>
            </tr>
            <tr>
                <td>Fname <span class="acsentric">*</span> :</td>
                <td><input type="text" name="fname" size="30" value="<%=request.getAttribute("fname") %>"  required/></td>
            </tr>
            <tr>
                <td>Lname <span class="acsentric">*</span> :</td>
                <td><input type="text" name="lname" size="30" value="<%=request.getAttribute("lname")%>" required /></td>
            </tr>
        	<tr>
        	...
        	<tr>
                ...
                <td><input type="date" name="date" size="30" placeholder="Date Of Birth" required /></td>
            </tr>
            
            <tr>
                <td>Age <span class="acsentric">*</span> :</td>
                <td><input type="number" name="age" size="30" placeholder="Age" required /></td>
            </tr>
            
            <tr>
                <td>Phone <span class="acsentric">*</span> :</td>
                <td><input type="tel" name="phone" size="30" placeholder="Contact-Number" required /></td>
            </tr>
