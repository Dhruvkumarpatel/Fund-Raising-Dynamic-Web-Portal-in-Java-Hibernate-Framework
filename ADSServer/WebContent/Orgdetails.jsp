...
-->
          ...
          <a href="OrganizationList.jsp"><h4> List Of Organization</h4></a>
           ...
           <table>
          		...
          		<%
          		ManageOrganization m3 = new ManageOrganization();
          		List value = m3.listOrganization();
          	...
          	for(int i=0;i<value.size();i++){
          			ORGANIZATION org = (ORGANIZATION)value.get(i);
          			
          			if(org.getORG_ID()==orgid)
          			{
          		%>
           		<tr>
           			<td><a href="Orgdetails.jsp?orgid=<%=orgid%>"><h5><%=org.getORG_NAME()%></h5></a></td>
           		</tr>
           ...
           <td><h6><%=org.getORG_TYPE() %></h6></td>
           </tr>
            <tr>
             <td>No_Of_Employee:</td>
           <td><h6><%=org.getTOTAL_EMPLOYEE() %></h6></td>
           </tr>
            <tr>
              <td>Organization Details:</td>
           <td><h6><%=org.getORG_DETAILS() %></h6></td>
           </tr>
            <tr>
              <td>Organization Goals:</td>
           <td><h6><%=org.getORG_GOALS()%></h6></td>
           </tr>
            <tr>
              <td>Organization Phone:</td>
           <td><h6><%=org.getORG_PHONE() %></h6></td>
           </tr>
            <tr>
            <td>Organization Website:</td>
           <td><h6><%=org.getORG_WEBSITE()%></h6></td>
           </tr>
            <tr>
            <td>Organization Address
            :</td>
           <td><h6><%=org.getORG_ADDRESS()%></h6></td>
           </tr>
          ...
          <%}
            ...
            <tr>
           <td><a href="Donation.jsp?orgid=<%=orgid%>"><h6>Click here to give Donation</h6></a></td>
           </tr>
