...
{
	alert("successfully inserted project information");
...
<div id="tooplate_wrapper">
   ...
   <h3>  Welcome to Fund Raising  </h3>
    ...
    <form action="projectservlet" method="post" name="update">
  
        <table cellpadding="3pt">
        
        	<tr>
                <td>Project Type <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="projecttype" size="30" required /></td>
            </tr>
        
           <tr>
                <td>Project Details <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="projectdetails" size="30" required /></td>
            </tr>
            <tr>
                <td>Project Name <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="projectname" size="30" required /></td>
            </tr>
