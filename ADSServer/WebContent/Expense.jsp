...
{
	alert("successfully inserted expense information");
...
<div id="tooplate_wrapper">
   ...
   <h3>  Welcome to Fund Raising  </h3>
    ...
    <form action="expenseservlet" method="post" name="update">
  
        <table cellpadding="3pt">
        
        	<tr>
                <td>Expense Type <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="expensetype" size="30" required /></td>
            </tr>
        
           <tr>
                <td>Expense Details <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="expensedetails" size="30" required /></td>
            </tr>
            <tr>
                <td>Expense Name <span class="acsentric">*</span> :</td> 
                <td><input type="text"  name="expensename" size="30" required /></td>
            </tr>
            
             <tr>
                <td>Expense Date<span class="acsentric">*</span> :</td> 
                <td><input type="date" name="expensedate" size="30" required /> </td>
            </tr>
 
          
            <tr>
                <td>Organization id: <span class="acsentric">*</span> :</td>
                <td><input type="text" name="orgid" size="30" value="<%=orgid%>" required/></td>
            </tr>
             <tr>
