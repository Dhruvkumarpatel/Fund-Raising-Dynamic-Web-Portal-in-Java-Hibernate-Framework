...
<div id="tooplate_wrapper">
   ...
   <h3>  Welcome to Fund Raising  </h3>
           ...
           <a href='UpdateOrganizationProfile.jsp?fname=${fname}&lname=${lname}'><h3>Update Profile</h3></a>
...
-->
           ...
           <table>
          		...
          		int donorid = Integer.valueOf(request.getParameter("donorid"));
          		
          		
          		
          	for(int i=0;i<value.size();i++){
          			DONOR d = (DONOR)value.get(i);
          			
          			if(d.getDONOR_ID()==donorid)
          			{
          		%>
           		<tr>
           			<td><a href="Donordetails.jsp?donorid=<%=donorid%>"><h5><%=d.getDONOR_NAME()%></h5></a></td>
           		</tr>
           ...
           <tr>
           <td>Donor Address:</td>
           <td><h6><%=d.getDONOR_ADDRESS() %></h6></td>
           </tr>
            <tr>
             <td>Donor DateOfBirth:</td>
           <td><h6><%=d.getDONOR_DOB() %></h6></td>
           </tr>
            <tr>
              <td>Donor Age:</td>
           <td><h6><%=d.getDONOR_AGE() %></h6></td>
           </tr>
            <tr>
              <td>Donor Details:</td>
           <td><h6><%=d.getDONOR_DETAILS()%></h6></td>
           </tr>
            <tr>
              <td>Donor Phone:</td>
           <td><h6><%=d.getDONOR_PHONE() %></h6></td>
           </tr>
          ...
          <%}
           ...
           <tr>
           <td><a href="email.jsp?donorid=<%=donorid%>"><h5>Click here to send an Email</h5></a></td>
           </tr>
