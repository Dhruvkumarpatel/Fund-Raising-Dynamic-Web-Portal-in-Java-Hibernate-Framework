...
public class DONOR {
	...
	public String getDONOR_DETAILS() {
		return DONOR_DETAILS;
	}

	public void setDONOR_DETAILS(String dONOR_DETAILS) {
	...
	public DONOR( String dONOR_NAME, String dONOR_ADDRESS, String dONOR_DOB, int dONOR_AGE,
